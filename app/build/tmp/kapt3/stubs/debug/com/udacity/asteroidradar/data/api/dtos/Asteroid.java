...
public final class Asteroid implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<com.udacity.asteroidradar.data.api.dtos.Asteroid> CREATOR = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.udacity.asteroidradar.data.api.dtos.Asteroid copy(long id, @org.jetbrains.annotations.NotNull()
    java.lang.String codename, @org.jetbrains.annotations.NotNull()
    java.lang.String closeApproachDate, double absoluteMagnitude, double estimatedDiameter, double relativeVelocity, double distanceFromEarth, boolean isPotentiallyHazardous) {
        return null;
    }
    ...
    public static final class Creator implements android.os.Parcelable.Creator<com.udacity.asteroidradar.data.api.dtos.Asteroid> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.udacity.asteroidradar.data.api.dtos.Asteroid[] newArray(int size) {
            return null;
        }
        
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.udacity.asteroidradar.data.api.dtos.Asteroid createFromParcel(@org.jetbrains.annotations.NotNull()
