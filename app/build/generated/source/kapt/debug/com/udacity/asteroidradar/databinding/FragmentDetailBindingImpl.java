...
public class FragmentDetailBindingImpl extends FragmentDetailBinding  {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindTextViewToAstronomicalUnit(this.absoluteMagnitude, asteroidAbsoluteMagnitude);
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindContentDescription(this.activityMainImageOfTheDay, asteroidPotentiallyHazardous);
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindDetailsStatusImage(this.activityMainImageOfTheDay, asteroidPotentiallyHazardous);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.closeApproachDate, asteroidCloseApproachDate);
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindTextViewToAstronomicalUnit(this.distanceFromEarth, asteroidDistanceFromEarth);
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindTextViewToKmUnit(this.estimatedDiameter, asteroidEstimatedDiameter);
            com.udacity.asteroidradar.util.BindingAdaptersKt.bindTextViewToDisplayVelocity(this.relativeVelocity, asteroidRelativeVelocity);
        }
    }
